...
# JC Note: DNS Hub is in the Project / VPC as the base hub
...
module "shared_base_interconnect" {
  ...
  region1_interconnect1_candidate_subnets = ["169.254.190.64/29"]
  region1_interconnect1_vlan_tag8021q     = "983"
  region1_interconnect1                   = "https://www.googleapis.com/compute/v1/projects/nih-ops-network-3407/global/interconnects/nih-gcp-max"
  region1_interconnect1_location          = "las-zone1-770"
  region1_interconnect1_onprem_dc         = "onprem-dc-1"
  ...
  region1_interconnect2_vlan_tag8021q     = "983"
  region1_interconnect2                   = "https://www.googleapis.com/compute/v1/projects/nih-ops-network-3407/global/interconnects/nih-gcp-i2"
  region1_interconnect2_location          = "las-zone1-770"
  region1_interconnect2_onprem_dc         = "onprem-dc-2"
